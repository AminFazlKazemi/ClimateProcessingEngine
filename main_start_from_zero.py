...
نسخه ۳.۶ – شروع اجباری از بلوک ۰ (auto_detect=False)
"""
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("🚀 CLIMATOLOGY PROCESSING ENGINE v3.6 (شروع از بلوک ۰)")
    ...
    try:
        ...
        # ============================================================
        # ۴. ✅ استفاده از checkpoint_manager با auto_detect=False
        # ============================================================
        # 🔴 تغییر مهم: auto_detect=False تا از ابتدا شروع کند
        ...
        # 🔴 انتخاب متغیرهای مورد نظر (برای صرفه‌جویی در زمان)
        # اگر می‌خواهید هر سه متغیر را پردازش کنید، از range(len(VARS)) استفاده کنید
        # var_indices = range(len(VARS))  # هر سه متغیر
        var_indices = [0, 2]  # فقط tmin و tmax (چون tmean کامل است)
        ...
        for block_idx in range(start_block, total_blocks):
            ...
            # ============================================================
            # ✅ پردازش هر متغیر انتخاب‌شده در یک بلوک
            # ============================================================
            for var_idx in var_indices:
                ...
                try:
                    ...
                    # پس از پردازش موفق هر متغیر، checkpoint را به‌روز می‌کنیم
                ...
                # Flush outliers بعد از هر متغیر (اختیاری)
                try:
                    flush_outliers_to_csv(
                    ...
                    logger.warning(f"⚠️ Failed to flush outliers: {e}")

            # پس از اتمام همه متغیرها، garbage collection
            gc.collect()
