...
fix_merge_final.py
================================================================================
بازنویسی کامل merge_results.py برای رفع خطای ImportError
================================================================================
"""
...
# پشتیبان
backup = MERGE_PATH.with_suffix(".py.bak_merge_final")
shutil.copy2(MERGE_PATH, backup)
...
print("✅ merge_results.py بازنویسی شد (تابع merge_results اضافه شد).")
